...
from .models import User, Task,  FinishedTask, Comment
from . import db
...
def delete_comment(comment_id):
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("views.description", task_id=comment.task_id))
    return render_template("delete_comment.html", task_id=comment.task_id)
...
def calendar():
    task = Task.query
    return render_template("calendar.html", user=current_user, task=task)
